    ...
    <div id="extra">
      <GridBackground colors={colorsExtra}>
        <div className="max-w-md px-4 text-center">
          ...
          <p className="mb-5">
            Reach out if you want to talk risk tools, finance workflows, or the
            next build.
          </p>
          ...
          <button
            className="z-10 mx-auto my-4 h-10 w-fit rounded-md border px-4 text-sm font-semibold shadow-sm transition hover:brightness-95"
            style={{
              background: colors[0],
              color: colors[2],
